...
minutelabel <- if (minutes == 1) "minute" else "minutes"
secondlabel <- if (seconds == 1) "second" else "seconds"

cat(var_seconds, "seconds is", minutes, minutelabel, "and", seconds, secondlabel)
```
...
if (num1 >= num2 && num1 >= num3) {
  cat("The largest number is", num1, "\n")
} else if (num2 >= num1 && num2 >= num3) {
  cat("The largest number is", num2, "\n")
} else {
  cat("The largest number is", num3, "\n")
}
```
